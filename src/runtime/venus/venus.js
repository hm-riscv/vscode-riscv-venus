(function (_, Kotlin) {
  ...
  Driver.prototype.externalAssemble = function (text, absPath, fileName) {
    if (absPath === void 0)
      absPath = '';
    if (fileName === void 0)
      fileName = 'main.s';
    ...
    var success = true;
    var errs = '';
    var tmp$_0 = Assembler_getInstance().assemble_6hosri$(text, fileName, absPath);
    var prog = tmp$_0.component1()
    , errors = tmp$_0.component2()
    , warnings = tmp$_0.component3();
    if (!errors.isEmpty()) {
  ...
  Renderer.prototype.printConsole_za3rmp$ = function (thing) {
    var tmp$;
    (tmp$ = this.emitter) != null ? tmp$.emit('printConsole', thing) : null;
  };
  Renderer.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Renderer',
